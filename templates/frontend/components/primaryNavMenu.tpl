...
<ul id="main-navigation" class="nav navbar-nav">
  ...
  {/if}
  <li class="dropdown">
    <a href="{url router=$smarty.const.ROUTE_PAGE page="awards"}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Award Tracks <span class="caret"></span></a>
